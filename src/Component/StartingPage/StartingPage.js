    ...
    <>
      <div className="sectionOne">
        <div className="liftSide">
          <div className="head">
            <div className="logo">
              <svg width="100" className="_1envo" viewBox="0 0 200 60">
          ...
          <div className="citie">
            <div>Ahmedabad</div>
            <div style={{ color: "#7e7e80" }}>Bangalore</div>
            <div>Chennai</div>
            <div style={{ color: "#7e7e80" }}>Delhi</div>
            <div>Gurgaon</div>
            <div style={{ color: "#7e7e80" }}>Hyderabad</div>
            <div>Kolkata</div>
            <div style={{ color: "#7e7e80" }}>Mumbai</div>
            <div>Pune</div>
            <div style={{ color: "#7e7e80" }}>& more.</div>
          </div>
        </div>
