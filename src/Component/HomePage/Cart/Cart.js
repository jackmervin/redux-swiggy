...
function Cart() {
  ...
  const totald =
    cartqun > 0 &&
    getprice.reduce((totel, current) => {
      return totel + current;
    });
  ...
  return (
    <>
      <div className="nav2">
        ...
        <div
          className="nav-right"
          style={{ justifyContent: "end", columnGap: "50px" }}
        >
          ...
          {loginCon && (
            <Link to="/my_account" style={{ textDecorationLine: "none" }}>
              <div className="profile hov">
                <svg
                  style={{ marginTop: "3px" }}
                  className="_1GTCc"
                ...
                &nbsp;{loginData[0].name.substring(0, 8)}..
              </div>
            </Link>
          )}
      ...
      {cartqun <= 0 && (
        <div className="nocart">
          <img className="nocartimg" src={cart} alt="img"></img>
          <div className="nocartheda">Your cart is empty</div>
          <div className="nocartp">
          ...
          <Link
            ...
            to="/Home"
          >
            <button className="nocartbtn">See restaurants near you</button>
          </Link>
        </div>
      )}
      {cartqun > 0 &&
          ...
          <div className="cart" key={data.id}>
            ...
            <div className="cartbilling">
              <div className="carthotelhead">
                <div className="carthotrlimg">
                  <Link to="/Home">
                    <img src={data.img} alt=""></img>
                  </Link>
                </div>
                <div className="carthotelditails">
                  <div className="cartheadname">{data.hotelName}</div>
                  <div className="cartheadlocation">{data.placeInChennai}</div>
                  <div className="cartborder"></div>
                </div>
                <div></div>
              </div>
              <div className="cartbillingditails">
                <div className="scroll">
                  {/* cart food array */}
                  {data.menu.map((food) => {
                    if (food.quantity > 0) {
                      return (
                        <div className="cartfood" key={food.foodId}>
                          ...
                          <div className="cartprice">₹{food.price}</div>
                        </div>
                      );
                    }
                    return null;
                  })}
                  <div className="suggestinos">
                    <svg
                      style={{ width: "10px" }}
                      class="_3iLcN"
                      viewBox="0 0 32 32"
                    ...
                    <input placeholder="Any suggestions? We will pass it on..."></input>
                  </div>
                  <div className="checkbox">
                    ...
                    >
                      Opt in for No-contact Delivery<br></br>
                      <span style={{ opacity: ".6", color: "#282c3f" }}>
                  ...
                  <div className="bill">
                    <div className="billname">Bill Details</div>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      <div>Item Total</div>
                      <div style={{ marginRight: "20px" }}>₹{totalamount}</div>
                    </div>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      ...
                      <div style={{ marginRight: "20px", color: "#fc8019" }}>
                        Add tip
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <div style={{ marginRight: "20px" }}>₹10</div>
                    </div>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      ...
                      <div style={{ marginRight: "20px" }}>₹60</div>
                    </div>
                  </div>
                </div>
              </div>{" "}
